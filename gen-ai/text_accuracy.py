...
document_matrix = vectorizer.fit_transform(textos)
  
# Dividindo os dados em conjuntos de treinamento e teste
X_train, X_test, y_train, y_test = train_test_split(document_matrix, categorias, test_size=0.5, random_state=42)
